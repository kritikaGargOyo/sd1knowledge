...
class MoviesDetailFragment (val moviesListResponse: MoviesListResponse): AppCompatDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        rootview?.findViewById<TextView>(R.id.rating)?.setText(moviesListResponse.vote_average.toString())
